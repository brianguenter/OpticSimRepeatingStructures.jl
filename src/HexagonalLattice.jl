...
basismatrix(a::HexBasis1{2,T}) where {T} = scale(a) * SMatrix{2,2,T}(T(1.5), T(0.5) * sqrt(T(3)), T(1.5), T(-0.5) * (sqrt(T(3))))
...
function neighbors(::Type{HexBasis1}, centerpoint::Tuple{Int64,Int64}, n::Int)
